...
void runNanoFakes(TString year = "2018", TString filename = "NONE")
{
  if (year == "2016_HIPM")
    ...
    {
      path_mc   = "/eos/cms/store/group/phys_higgs/cmshww/calderon/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9_fakeSelKinMC/";
      path_data = "/eos/cms/store/group/phys_higgs/cmshww/calderon/HWWNano/Run2018_UL2018_nAODv9_Full2018v9/DATAl1loose2018v9_fakeSel/";
    }
  else
    {
